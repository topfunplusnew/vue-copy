...
import type { CreatePaperCommentData, UpdatePaperCommentData } from './type';
 ...
 */
export const getPaperComments = (paperId: number | string) => http.get(`/paper/${paperId}/comments`);
...
export const createPaperComment = (paperId: number | string, data: CreatePaperCommentData) =>
  http.post(`/paper/${paperId}/comments`, data, {
    headers: {
...
export const updatePaperComment = (paperId: number | string, data: UpdatePaperCommentData) =>
  http.put(`/paper/${paperId}/comments`, data, {
    headers: {
      'Content-Type': 'application/json',
    },
  });
